    ...
    tss::Skin& skin)
{
    ...
    auto slider = std::make_unique<tss::Slider>(skin, static_cast<double>(desc->defaultValue));
    ...
    tss::Skin& skin)
{
    ...
    auto comboBox = std::make_unique<tss::ComboBox>(skin);
    ...
    tss::Skin& skin)
{
    ...
    auto button = std::make_unique<tss::Button>(
        skin, 
        tss::SkinDimensions::Widget::Button::kDefaultWidth, 
        desc->displayName
    );
...
{
    return ApvtsFactory::getGroupDisplayName(groupId);
}
