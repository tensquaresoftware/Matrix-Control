...
public:
    ...
    static int getWidth() { return PluginDimensions::Panels::PatchEditPanel::BottomPanel::Env1Panel::kWidth; }
    static int getHeight() { return PluginDimensions::Panels::PatchEditPanel::BottomPanel::Env1Panel::kHeight; }
