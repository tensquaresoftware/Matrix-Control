...
public:
    ...
    static int getWidth() { return PluginDimensions::Panels::PatchEditPanel::TopPanel::FmTrackPanel::kWidth; }
    static int getHeight() { return PluginDimensions::Panels::PatchEditPanel::TopPanel::FmTrackPanel::kHeight; }
