...
public:
    ...
    static int getWidth() { return PluginDimensions::Panels::PatchEditPanel::TopPanel::Dco2Panel::kWidth; }
    static int getHeight() { return PluginDimensions::Panels::PatchEditPanel::TopPanel::Dco2Panel::kHeight; }
