...
namespace
{
    using NamedLayout = std::pair<const char*, ModulePanelLayout>;

    NamedLayout dco1PanelLayout()
    {
        return { "Dco1Panel",
    ...
    NamedLayout fmTrackPanelLayout()
    {
        return { "FmTrackPanel",
                 makePatchEditInitOnlyModuleLayout(
    ...
    NamedLayout rampPortamentoPanelLayout()
    {
        return { "RampPortamentoPanel",
                 makePatchEditInitOnlyModuleLayout(
    ...
    NamedLayout vibratoPanelLayout()
    {
        return { "VibratoPanel",
                 makeMasterEditModuleLayout(
